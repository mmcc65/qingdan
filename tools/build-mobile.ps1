...
$env:GRADLE_USER_HOME = Join-Path $root 'mobile\android\.gradle-user-home'
...
$project = Join-Path $root 'mobile\android'
$signingProperties = Join-Path $root 'mobile\signing\private\signing.properties'
...
$outputDir = Join-Path $root 'mobile\output'
...
if (Test-Path -LiteralPath $signingProperties) {
    ...
    $releaseManifest = [ordered]@{
        ...
        sha256 = $releaseHash
        notes = [Text.Encoding]::UTF8.GetString([Convert]::FromBase64String('5paw5aKe6aG555uu5YaF5aSa57qn5a2Q6aG555uu77yM5Lul5Y+K5bqU55So5YaF6Ieq5Yqo5qOA5p+l44CB5LiL6L295ZKM5a6J6KOF5pu05paw44CC'))
    } | ConvertTo-Json
